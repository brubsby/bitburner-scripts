...
export async function main(ns) {
  ...
  if (!raiseRam(ns, want, RAMOVERRIDE_STATUS, 'faction.js needs its full allocation before the first gated call')) return
...
export const factions = {
  ...
  "Daedalus": {
    short_name: "Daedalus",
    requirements: {
      augmentations: 30 * readBitNodeMults().DaedalusAugsRequirement,
      money: 100000000000,
      hacking: 2500,
      strength: 1500,
      defense: 1500,
